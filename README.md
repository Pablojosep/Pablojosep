...
![Eagle](https://img.shields.io/badge/Eagle-007ACC?style=flat)
### Firmware & Software
...
| MCU / SBC | Toolchain |
|---|---|
| ESP32-C3 / S3 / H2 | ESP-IDF |
| Nordic nRF54L15 | Zephyr RTOS |
| RP2040 / RP2350 | Pico SDK |
| STM32F7 | STM32CubeIDE / HAL |
| Raspberry Pi 3/4/5, CM4 | Raspberry Pi OS / Linux |
### Protocols
I2C · SPI · UART · MIPI — driver development and component selection
---
### About
Electronics Engineer and Industrial Automation Specialist with 18+ years of experience.
Currently developing complete embedded products in Porto.
Previously: 10 years in Oil & Gas wireline field operations (Halliburton / Expro), industrial plant engineering, and telecom field infrastructure.
I speak Spanish (native), English (C1 — TOEFL iBT 97), and Portuguese (professional).
---
📍 Porto, Portugal  
🔗 [linkedin.com/in/pablo-penuela](https://linkedin.com/in/pablo-penuela)
